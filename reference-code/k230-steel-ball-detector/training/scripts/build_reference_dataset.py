#!/usr/bin/env python3
"""Make a reproducible K230 training split from the vetted reference dataset.

The downloaded reference model targets MaixCAM2 and cannot run on K230, but
its 237 field images and 3,000 copy-paste field scenes use valid YOLO labels.
We keep those source files in ``reference/`` and use file lists instead of
duplicating several hundred megabytes of images.
"""
...
REFERENCE = ROOT / "reference" / "maixcam2-steel-ball-v5" / "data"
